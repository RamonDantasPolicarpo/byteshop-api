--## Criando o banco de dados para a API

--CREATE DATABASE byteshop_ecommerce;
CREATE SCHEMA loja;
...
('12233445567', 'Laura Moreira', '1995-04-12', 'laura.m@email.com', '04538133', 'Av. Brigadeiro Faria Lima, 3477', 'São Paulo', 'SP'),
('22334455667', 'Pedro Nogueira', '1988-08-30', 'pedro.n@email.com', '22290160', 'Av. Pasteur, 120', 'Rio de Janeiro', 'RJ'),
('33445566778', 'Mariana Costa', '2001-11-05', 'mari.costa@email.com', '88015420', 'Av. Beira Mar Norte, 220', 'Florianópolis', 'SC'),
('44556677889', 'Lucas Andrade', '1993-01-20', 'lucas.a@email.com', '13025151', 'Rua Coronel Quirino, 999', 'Campinas', 'SP'),
('55667788990', 'Beatriz Almeida', '1982-03-15', 'bia.almeida@email.com', '51020000', 'Av. Conselheiro Aguiar, 1472', 'Recife', 'PE'),
('66778899001', 'Guilherme Barros', '2003-07-22', 'gui.barros@email.com', '74120110', 'Rua 9, 85', 'Goiânia', 'GO'),
('77889900112', 'Helena Pereira', '1997-09-01', 'helena.p@email.com', '29055035', 'Rua Aleixo Netto, 322', 'Vitória', 'ES'),
('88990011223', 'Igor Martins', '1989-05-18', 'igor.m@email.com', '60170002', 'Av. Beira Mar, 3620', 'Fortaleza', 'CE'),
('99001122334', 'Juliana Lima', '1991-02-28', 'juli.lima@email.com', '65066659', 'Av. dos Holandeses, 10', 'São Luís', 'MA'),
('00112233445', 'Felipe Azevedo', '1990-10-10', 'felipe.az@email.com', '79020200', 'Rua Afonso Pena, 4909', 'Campo Grande', 'MS');
...
('GAME-PS5-SLM', 'Console PlayStation 5 Slim', 3999.90, 'Games', 25),
('GAME-XBS-X', 'Console Xbox Series X', 4349.00, 'Games', 30),
('GAME-NINT-SW', 'Console Nintendo Switch OLED', 2199.00, 'Games', 40),
('CTRL-DUAL-S', 'Controle PS5 DualSense', 429.90, 'Games', 150),
('HEAD-PULSE-3D', 'Headset Sony Pulse 3D', 549.90, 'Games', 80),
('DEC-QUADRO-ABS', 'Quadro Decorativo Abstrato', 189.90, 'Decoração', 60),
('DEC-VASO-CER', 'Vaso de Cerâmica Moderno', 79.90, 'Decoração', 120),
('DEC-LUM-PISO', 'Luminária de Piso Industrial', 299.00, 'Decoração', 45),
('DEC-ALM-VEL', 'Almofada de Veludo', 59.90, 'Decoração', 200),
('PET-CAMA-CONF', 'Cama para Cachorro Confortável', 129.90, 'Pet Shop', 90),
('PET-ARR-GATO', 'Arranhador para Gatos', 89.90, 'Pet Shop', 110),
('PET-RAC-GOLD', 'Ração Golden 15kg', 189.90, 'Pet Shop', 250),
('SMT-ALEXA-ECHO', 'Amazon Echo Dot 5ª Geração', 349.00, 'Eletrônicos', 300),
('LIV-ESSENCIAL', 'Livro: O Essencialismo', 45.00, 'Livros', 180),
('FER-ESC-BOSCH', 'Escada de Alumínio 5 Degraus', 199.00, 'Ferramentas', 70);
...
('PED-2025-00051', '2025-10-01', 31, 4), 
('PED-2025-00052', '2025-10-02', 32, 4), 
('PED-2025-00053', '2025-10-03', 33, 3),
('PED-2025-00054', '2025-10-04', 34, 4), 
('PED-2025-00055', '2025-10-05', 35, 5), 
('PED-2025-00056', '2025-10-06', 36, 4),
('PED-2025-00057', '2025-10-07', 37, 4), 
('PED-2025-00058', '2025-10-08', 38, 4), 
('PED-2025-00059', '2025-10-09', 39, 2),
('PED-2025-00060', '2025-10-10', 40, 4), 
('PED-2025-00061', '2025-10-11', 1, 3), 
('PED-2025-00062', '2025-10-12', 2, 4),
('PED-2025-00063', '2025-10-13', 3, 4), 
('PED-2025-00064', '2025-10-14', 4, 4), 
('PED-2025-00065', '2025-10-15', 5, 1),
('PED-2025-00066', '2025-10-16', 16, 4), 
('PED-2025-00067', '2025-10-17', 17, 4), 
('PED-2025-00068', '2025-10-18', 18, 4),
('PED-2025-00069', '2025-10-19', 19, 3), 
('PED-2025-00070', '2025-10-20', 20, 1);
